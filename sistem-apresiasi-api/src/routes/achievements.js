...
router.post("/independents", authenticateToken, tryCatch(postAchievementIndependentController))
router.get("/independents", authenticateToken, tryCatch(getAchievementIndependentController))
router.get(
...
router.get("/noncompetitions", authenticateToken, tryCatch(getAchievementNonCompetitionsController))
router.get(
