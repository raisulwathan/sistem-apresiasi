    ...
    <div className="w-[1130px] h-[700px] p-6 ">
      ...
      <form onSubmit={handleSubmit} className=" space-y-14">
        ...
        <div className="flex items-center">
          ...
          <input type="number" id="numberOfStudent" value={formData.numberOfStudent} onChange={handleInputChange} className="flex-grow ml-[129px] p-2 border border-secondary rounded-lg" />
        </div>
        <div className="flex items-center">
        ...
        <div className="flex items-center">
          ...
          <input type="file" id="file" onChange={handleFileChange} className="flex-grow p-2 ml-[129px] border rounded-lg border-secondary" />
        </div>
