...
import FormulirMahasiswaBerwiraUsaha from "./FormulirMahasiswaBerwiraUsaha";

function MahasiswaBerwiraUsaha() {
  ...
  const category = "Mahasiswa Berwirausaha";
  ...
  const handleExports = async () => {
    try {
      ...
      link.href = fileURL;
      link.setAttribute("download", "Mahasiswa_Berwirausaha.xlsx");
  ...
  return (
    <div className="h-screen p-16 bg-[#424461] overflow-y-auto">
      <h2 className="font-semibold text-gray-300 lg:text-[26px] font-poppins">Mahasiswa Berwira Usaha</h2>
        ...
        {showForm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="relative w-[1000px] h-auto p-8 bg-[#313347] rounded-lg">
              ...
              <FormulirMahasiswaBerwiraUsaha onSubmit={handleFormSubmit} />
            </div>
          </div>
        )}
...
export default MahasiswaBerwiraUsaha;
